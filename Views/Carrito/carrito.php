...
<hr>
    ...
    <?php 
       ...
       //si existe la variable de session y la cantidad de registros es mayor a 0 entonces va a mostrando la vista
        $subtotal = 0;
        $total = 0;
							...
							<table id="tblCarrito" class="table-shopping-cart">
                                ...
                                <?php 
                                  foreach($_SESSION['arrCarrito'] as $producto) {
                                    ...
                                    $subtotal = $subtotal + $totalProducto; //subtotal + los totales
                                    $idProducto = openssl_encrypt($producto['idproducto'],METHODENCRIPT,KEY);
                                
                                ?>
                                <!--le enviamos como clase el id del producto encryptado-->
								<tr class="table_row <?= $idProducto ?>" >
									...
									<td class="column-3"><?= SMONEY.formatoMoney($producto['precio']) ?></td>
									<td class="column-4">
                                    ...
                                    <!--TOTAL DE PRODUCTO-->
									<td class="column-5"><?= SMONEY.formatoMoney($totalProducto) ?></td>
                                </tr>
						...
						<div class="flex-w flex-t p-t-27 p-b-33">
							...
							<div class="size-209 p-t-1">
								<span id="totalCompra" class="mtext-110 cl2">
									...
									<?=  SMONEY.formatoMoney($subtotal+COSTOENVIO) ?>
								</span>
							</div>
						</div>
                      <!-- tipo submit para que se ejecute-->
