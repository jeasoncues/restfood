	...
	<table align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="text-align:center;">
		<tbody>
			...
			<tr>
				<td>
					<div class="x_sgwrap">
                    <!--Variable data del nombre del usuario-->
						<p>Hola <?= $data['nombreUsuario']; ?></p>
					</div>
                     
                    <p>Bienvenido a Doanttos Restaurante</p>
                    <p>Ahora puedes realizar tu flato favorito en linea sin salir de casa.</p>
                    <p>Accede a tu cuenta con tus credenciales:</p>
                    <p>Usuarios: <strong><?= $data['email']; ?></strong></p>
                    <p>Contraseña: <strong><?= $data['password']; ?></strong></p>
                    <a href="<?= BASE_URL; ?>" target=" blank" class="x_button_link x_link_blue">Comprar ahora</a>
                    <!--Variable global de config-->
