...
<br><br>
    ...
    <div class="jumbotron text-center">
        <h1 class="display-4">¡Gracias por tu compra!</h1>
            <p class="lead">Tu pedido fue procesador con éxito.</p>
            <p>No. Pedido: <strong> <?= $data['orden']; ?> </strong></p>

            <!-- validacion para saber si no esta vacio la variable transaccion en caso no realicemos pago contra entrega no mostrara la variable transaccion-->
            <?php 
