...
<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <!--Enviamos ruta de categoria con su respectivo nombre al que pertence-->
				...
				<div class="col-md-6 col-lg-7 p-b-30">
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<!-- validacion para saber si el producto tiene imagenes-->
							<?php 
							  if(!empty($arrImages)){
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2">
							<?= SMONEY.formatoMoney($arrProducto['precio']); ?>
						</span>
						...
						<div class="p-t-33">
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
                                   ...
                                   <!--funcion OPENSSL_ENCRYPT => SIRVE PARA ENCRIPTAR, METHODENCRIPT => METODO DE ENCRIPTACION CREADA EN CONFIG-->
						...
						<div class="flex-w flex-m p-l-100 p-t-40 respon7">
							<div class="flex-m bor9 p-r-10 m-r-11">
								<a href="#" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 js-addwish-detail tooltip100" data-tooltip="Me gusta">
	...
	<section class="sec-relate-product bg0 p-t-45 p-b-105">
		<div class="container">
			...
			<div class="wrap-slick2">
				<div class="slick2">
				<!--Si no esta vacio muestra todo eso -->
				<?php 
